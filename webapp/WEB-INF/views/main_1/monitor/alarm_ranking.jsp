...
<div class="page-wrap">
  ...
  <div class="period-tab">
    <button class="tab-btn active" onclick="setPeriod('custom',this)">${not empty defaultFrom ? defaultFrom : '2026-06-01'} ~ ${not empty defaultTo ? defaultTo : '2026-06-17'}</button>
...
var curPeriod = 'custom';
var charts  = {};
var CUSTOM_FROM = '${not empty defaultFrom ? defaultFrom : "2026-06-01"}';
var CUSTOM_TO   = '${not empty defaultTo   ? defaultTo   : "2026-06-17"}';
...
function periodStart(p){
  ...
  else return null; // 'all', 'custom'
  return d;
}

function filterByPeriod(data, p){
  if(p === 'custom'){
    var s = CUSTOM_FROM ? new Date(CUSTOM_FROM) : null;
    var e = CUSTOM_TO   ? new Date(CUSTOM_TO + 'T23:59:59') : null;
    return data.filter(function(r){
      var t = new Date(r.occurTime||r.occurrTime||0);
