...
<body>
  ...
  <div class="cs-panel" id="cs-panel">
    ...
    <div class="cs-items">
      <div class="cs-item cs-ok">NO.12</div>
      <div class="cs-item cs-ok">NO.1</div>
      <div class="cs-item cs-ok">NO.2</div>
      <div class="cs-item cs-ok">NO.3</div>
      <div class="cs-item cs-ok">NO.4</div>
      <div class="cs-item cs-ok">NO.10</div>
      <div class="cs-item cs-ok">NO.5</div>
    </div>
  </div>
...
(function () {
  ...
  function fetchData() {
    ...
    .catch(function (err) {
      console.warn('[monitor] PLC fetch 실패:', err);
