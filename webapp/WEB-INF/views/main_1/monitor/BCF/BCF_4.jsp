...
<div class="page-wrap">
  ...
  <div class="group-1">
    ...
    <!-- ═══ 기존 설비 작화 (변경 없음) ═══ -->
      ...
      <img class="bcf-1-pipe-on bcf4_131" src="<%= ctx %>/img/bcf1/bcf-1-pipe-on0.png" />
      <div class="bcf-oil bcf4_12"></div>
      ...
      <img class="bcf-1-arrow bcf4_38 bcf4_4" src="<%= ctx %>/img/bcf1/bcf-1-arrow0.png" />
      <img class="bcf-1-obj-2" src="<%= ctx %>/img/bcf1/bcf-1-obj-20.png" />
      <img class="bcf-1-obj-3" src="<%= ctx %>/img/bcf1/bcf-1-obj-30.png" />
      <img class="bcf-1-firepipe-off bcf4_29" src="<%= ctx %>/img/bcf1/bcf-1-firepipe-off0.png" />
      <img class="bcf-1-firepipe-on  bcf4_29" src="<%= ctx %>/img/bcf1/bcf-1-firepipe-on0.png" />
      <img class="bcf-1-phone-off-2" src="<%= ctx %>/img/bcf1/bcf-1-phone-off-20.png" />
      <img class="bcf-1-phone-on-2 bcf4_14" src="<%= ctx %>/img/bcf1/bcf-1-phone-on-20.png" />
      <img class="bcf-1-phone-off-1" src="<%= ctx %>/img/bcf1/bcf-1-phone-off-10.png" />
      <img class="bcf-1-phone-on-1 bcf4_13" src="<%= ctx %>/img/bcf1/bcf-1-phone-on-10.png" />
      ...
      <img class="bcf-1-stick-off-1 bcf4_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-off-10.png" />
      <img class="bcf-1-stick-on-1 bcf4_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-on-10.png" />
      <img class="bcf-1-stick-off-2 bcf4_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-off-20.png" />
      <img class="bcf-1-stick-on-2 bcf4_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-on-20.png" />
      ...
      <img class="bcf-1-motor-on bcf4_46" src="<%= ctx %>/img/bcf1/bcf-1-motor-on0.png" />
      <img class="bcf-1-pen-off" src="<%= ctx %>/img/bcf1/bcf-1-pen-off0.png" />
      <img class="bcf-1-pen-on bcf4_22" src="<%= ctx %>/img/bcf1/bcf-1-pen-on0.png" />
      <img class="bcf-1-tray-1 bcf4_51" src="<%= ctx %>/img/bcf1/bcf-1-tray-10.png" />
      <img class="bcf-1-tray-2 bcf4_3" src="<%= ctx %>/img/bcf1/bcf-1-tray-20.png" />
      <img class="bcf-1-tray-3" src="<%= ctx %>/img/bcf1/bcf-1-tray-30.png" />
      <img class="bcf-1-bong-1" src="<%= ctx %>/img/bcf1/bcf-1-bong-10.png" />
      <img class="bcf-1-bong-2 bcf4_34" src="<%= ctx %>/img/bcf1/bcf-1-bong-20.png" />
      <img class="bcf-1-bong-3 bcf4_33" src="<%= ctx %>/img/bcf1/bcf-1-bong-30.png" />
      <img class="bcf-1-door-open-1  bcf4_2" src="<%= ctx %>/img/bcf1/bcf-1-door-open-10.png" />
      <img class="bcf-1-door-close-1  bcf4_2" src="<%= ctx %>/img/bcf1/bcf-1-door-close-10.png" />
      <img class="bcf-1-bong-4" src="<%= ctx %>/img/bcf1/bcf-1-bong-40.png" />
      <img class="bcf-1-bong-5 bcf4_2" src="<%= ctx %>/img/bcf1/bcf-1-bong-50.png" />
      <img class="bcf-1-bong-6 bcf4_2" src="<%= ctx %>/img/bcf1/bcf-1-bong-60.png" />
      ...
      <img class="bcf-1-air-cycle bcf4_60" src="<%= ctx %>/img/bcf1/bcf-1-air-cycle0.png" />
      <img class="bcf-1-sensor-off-1" src="<%= ctx %>/img/bcf1/bcf-1-sensor-off-10.png" />
      <img class="bcf-1-sensor-on-1 bcf4_9" src="<%= ctx %>/img/bcf1/bcf-1-sensor-on-10.png" />
      ...
      <img class="bcf-1-alarm-3 bcf4_76" src="<%= ctx %>/img/bcf1/bcf-1-alarm-30.png" />
      <img class="bcf-1-alarm-4 bcf4_90" src="<%= ctx %>/img/bcf1/bcf-1-alarm-40.png" />
      <img class="bcf-1-alarm-5 bcf4_88" src="<%= ctx %>/img/bcf1/bcf-1-alarm-50.png" />
      <img class="bcf-1-alarm-6 bcf4_66" src="<%= ctx %>/img/bcf1/bcf-1-alarm-60.png" />
      <img class="bcf-1-alarm-7 bcf4_67" src="<%= ctx %>/img/bcf1/bcf-1-alarm-70.png" />
      <img class="bcf-1-alarm-8 bcf4_79" src="<%= ctx %>/img/bcf1/bcf-1-alarm-80.png" />
      <img class="bcf-1-alarm-9 bcf4_69" src="<%= ctx %>/img/bcf1/bcf-1-alarm-90.png" />
      <img class="bcf-1-alarm-10 bcf4_81" src="<%= ctx %>/img/bcf1/bcf-1-alarm-100.png" />
      <img class="bcf-1-alarm-11 bcf4_80" src="<%= ctx %>/img/bcf1/bcf-1-alarm-110.png" />
      ...
      <div class="bcf-1-manual-box-1 bcf4_136"></div>
      <div class="bcf-1-auto-box-1 bcf4_137"></div>
      <div class="bcf-1-stop-box-2"></div>
      <div class="bcf-1-manual-box-2 bcf4_134"></div>
    ...
    <div class="bcf-right-panel">
      ...
      <div class="bcf-top-row">
        ...
        <div class="bcf-left-col">
          ...
          <div class="bcf-temp-panel">
            ...
            <div class="tp-grid">
              ...
              <div class="tp-dc"><div class="tp-val BCF4_40046">--</div></div>
              <div class="tp-dc"><div class="tp-val BCF4_40047">--</div></div>
              <div class="tp-dc tp-last-col"><div class="tp-val blue BCF4_40052">--</div></div>

              <!-- SP 행 (설정값) -->
              <div class="tp-row-label tp-last-row">SP</div>
              <div class="tp-dc tp-last-row"><div class="tp-val BCF4_40069">--</div></div>
              <div class="tp-dc tp-last-row"><div class="tp-val BCF4_40070">--</div></div>
              <div class="tp-dc tp-last-col tp-last-row"><div class="tp-val blue BCF4_40071">--</div></div>
        ...
        <div class="bcf-auto-panel">
          ...
          <div class="auto-list">
            <div class="auto-item state-red" data-tag="bcf4_25"  data-text-0="수동 SS"            data-text-1="자동 SS">수동 SS</div>
            <div class="auto-item state-gray" data-tag="bcf4_20" data-text-0="DC POWER OFF"       data-text-1="DC POWER ON"  data-gray="true">DC POWER OFF</div>
            <div class="auto-item state-red" data-tag="bcf4_19"  data-text-0="비상정지"            data-text-1="비상정지">비상정지</div>
            <div class="auto-item state-red" data-tag="bcf4_15"  data-text-0="배기 파이로트 OFF"   data-text-1="배기 파이로트 ON">배기 파이로트 OFF</div>
            <div class="auto-item state-green" data-tag="bcf4_18" data-text-0="입구문 파이로트 OFF" data-text-1="입구문 파이로트 ON" data-invert="true">입구문 파이로트 OFF</div>
            <div class="auto-item state-red" data-tag="bcf4_17"  data-text-0="입구문 커튼SW OFF"   data-text-1="입구문 커튼SW ON">입구문 커튼SW OFF</div>
            <div class="auto-item state-red" data-tag="bcf4_22"  data-text-0="팬 정지"             data-text-1="팬 구동">팬 정지</div>
            <div class="auto-item state-red" data-tag="bcf4_1"   data-text-0="입구문 열림"         data-text-1="입구문 닫힘">입구문 열림</div>
            <div class="auto-item state-red" data-tag="bcf4_4"   data-text-0="E/V 하강"            data-text-1="E/V 상승">E/V 하강</div>
            <div class="auto-item state-red" data-tag="bcf4_7"   data-text-0="중간문 닫힘"         data-text-1="중간문 닫힘">중간문 닫힘</div>
            <div class="auto-item state-red" data-tag="bcf4_107" data-text-0="로내롤러 자동조강"    data-text-1="로내롤러 자동조강">로내롤러 자동조강</div>
            <div class="auto-item state-red" data-tag="bcf4_53"  data-text-0="장입 자동스탭 준비"  data-text-1="장입 자동스탭 준비">장입 자동스탭 준비</div>
            <div class="auto-item state-red" data-tag="bcf4_54"  data-text-0="본체 자동스탭 준비"  data-text-1="본체 자동스탭 준비">본체 자동스탭 준비</div>
            <div class="auto-item state-red" data-tag="bcf4_55"  data-text-0="추출 자동스탭 준비"  data-text-1="추출 자동스탭 준비">추출 자동스탭 준비</div>
          </div>
        </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF4_40015 -->
        <td colspan="2"><div class="zbox red BCF4_40015">BCF4_40015</div></td>
        <!-- 승온2 → BCF4_40016 -->
        <td colspan="2"><div class="zbox red BCF4_40016">BCF4_40016</div></td>
        <!-- 침탄1 → BCF4_40017 -->
        <td colspan="2"><div class="zbox red BCF4_40017">BCF4_40017</div></td>
        <!-- 침탄2 → BCF4_40018 -->
        <td colspan="2"><div class="zbox red BCF4_40018">BCF4_40018</div></td>
        <!-- 확산1 → BCF4_40019 -->
        <td colspan="2"><div class="zbox red BCF4_40019">BCF4_40019</div></td>
        <!-- 확산2 → BCF4_40020 -->
        <td colspan="2"><div class="zbox red BCF4_40020">BCF4_40020</div></td>
        <!-- 강온 → BCF4_40021 -->
        <td colspan="2"><div class="zbox red BCF4_40021">BCF4_40021</div></td>
        <!-- 로냉 → BCF4_40023 -->
        <td colspan="2"><div class="zbox red BCF4_40023">BCF4_40023</div></td>
        <!-- 드레인 → BCF4_40025 -->
        <td colspan="2"><div class="zbox red BCF4_40025">BCF4_40025</div></td>
      </tr>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF4_40028 -->
        <td colspan="2"><div class="zbox yellow BCF4_40028">BCF4_40028</div></td>
        <!-- 승온2 → BCF4_40029 -->
        <td colspan="2"><div class="zbox yellow BCF4_40029">BCF4_40029</div></td>
        <!-- 침탄1 → BCF4_40030 -->
        <td colspan="2"><div class="zbox yellow BCF4_40030">BCF4_40030</div></td>
        <!-- 침탄2 → BCF4_40031 -->
        <td colspan="2"><div class="zbox yellow BCF4_40031">BCF4_40031</div></td>
        <!-- 확산1 → BCF4_40032 -->
        <td colspan="2"><div class="zbox yellow BCF4_40032">BCF4_40032</div></td>
        <!-- 확산2 → BCF4_40033 -->
        <td colspan="2"><div class="zbox yellow BCF4_40033">BCF4_40033</div></td>
        <!-- 강온 → BCF4_40034 -->
        <td colspan="2"><div class="zbox yellow BCF4_40034">BCF4_40034</div></td>
        <!-- 로냉 → BCF4_40035 -->
        <td colspan="2"><div class="zbox yellow BCF4_40035">BCF4_40035</div></td>
        <!-- 드레인 → BCF4_40036 -->
        <td colspan="2"><div class="zbox yellow BCF4_40036">BCF4_40036</div></td>
      </tr>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF4_40046 (공유) -->
        <td colspan="2"><div class="zbox BCF4_40046">BCF4_40046</div></td>
        <!-- 승온2 → BCF4_40046 -->
        <td colspan="2"><div class="zbox BCF4_40046">BCF4_40046</div></td>
        <!-- 침탄1 → BCF4_40046 -->
        <td colspan="2"><div class="zbox BCF4_40046">BCF4_40046</div></td>
        ...
        <td colspan="2"><div class="zbox BCF4_40046">BCF4_40046</div></td>
        <!-- 로냉 → BCF4_40047 -->
        <td colspan="2"><div class="zbox BCF4_40047">BCF4_40047</div></td>
        <!-- 드레인 → BCF4_40047 -->
        <td colspan="2"><div class="zbox BCF4_40047">BCF4_40047</div></td>
      </tr>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF4_40038 -->
        <td colspan="2"><div class="zbox yellow BCF4_40038">BCF4_40038</div></td>
        <!-- 승온2 → BCF4_40039 -->
        <td colspan="2"><div class="zbox yellow BCF4_40039">BCF4_40039</div></td>
        <!-- 침탄1 → BCF4_40040 -->
        <td colspan="2"><div class="zbox yellow BCF4_40040">BCF4_40040</div></td>
        <!-- 침탄2 → BCF4_40041 -->
        <td colspan="2"><div class="zbox yellow BCF4_40041">BCF4_40041</div></td>
        <!-- 확산1 → BCF4_40042 -->
        <td colspan="2"><div class="zbox yellow BCF4_40042">BCF4_40042</div></td>
        <!-- 확산2 → BCF4_40043 -->
        <td colspan="2"><div class="zbox yellow BCF4_40043">BCF4_40043</div></td>
        <!-- 강온 → BCF4_40044 -->
        <td colspan="2"><div class="zbox yellow BCF4_40044">BCF4_40044</div></td>
        <!-- 로냉 → BCF4_40070 -->
        <td colspan="2"><div class="zbox yellow BCF4_40070">BCF4_40070</div></td>
        <!-- 드레인 → BCF4_40070 -->
        <td colspan="2"><div class="zbox yellow BCF4_40070">BCF4_40070</div></td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 침탄1 → BCF4_40052 -->
        <td colspan="2"><div class="zbox cyan BCF4_40052">BCF4_40052</div></td>
        <!-- 침탄2 → BCF4_40052 -->
        <td colspan="2"><div class="zbox cyan BCF4_40052">BCF4_40052</div></td>
        <!-- 확산1 → BCF4_40052 -->
        <td colspan="2"><div class="zbox cyan BCF4_40052">BCF4_40052</div></td>
      ...
      <tr>
        ...
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 침탄1 → BCF4_40048 -->
        <td colspan="2"><div class="zbox cyan BCF4_40048">BCF4_40048</div></td>
        <!-- 침탄2 → BCF4_40049 -->
        <td colspan="2"><div class="zbox cyan BCF4_40049">BCF4_40049</div></td>
        <!-- 확산1 → BCF4_40050 -->
        <td colspan="2"><div class="zbox cyan BCF4_40050">BCF4_40050</div></td>
        <!-- 확산2 → BCF4_40051 -->
        <td colspan="2"><div class="zbox cyan BCF4_40051">BCF4_40051</div></td>
        <!-- 강온 → empty -->
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 로냉 → empty -->
        <td colspan="2"><div class="zbox empty"></div></td>
...
(function() {
  ...
  /* DOM 스캔
     bcf4_숫자    → 비트(show/hide)
     BCF4_숫자    → 아날로그(→ bcf4_s_숫자 키)
     [data-tag]   → 자동운전 상태 아이템 (색+텍스트 갱신) */
  var bitElMap    = {};  // 'bcf4_12'      → [el, ...]
  ...
  document.querySelectorAll('[data-tag]').forEach(function(el) {
    var tag = el.getAttribute('data-tag');  // e.g. 'bcf4_25'
  ...
  function applyData(data) {
    ...
    /* 비트: 1→보임, 0→숨김 / bcf4_59 예외: 1→회전, 0→정지 */
