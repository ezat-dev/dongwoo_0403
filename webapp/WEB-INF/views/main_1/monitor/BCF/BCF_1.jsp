...
<div class="page-wrap">
  ...
  <div class="group-1">
    ...
    <!-- ═══ 기존 설비 작화 (변경 없음) ═══ -->
      ...
      <img class="bcf-1-pipe-on bcf1_131" src="<%= ctx %>/img/bcf1/bcf-1-pipe-on0.png" />
      <div class="bcf-oil bcf1_12"></div>
      ...
      <img class="bcf-1-arrow bcf1_38 bcf1_4" src="<%= ctx %>/img/bcf1/bcf-1-arrow0.png" />
      <img class="bcf-1-obj-2" src="<%= ctx %>/img/bcf1/bcf-1-obj-20.png" />
      <img class="bcf-1-obj-3" src="<%= ctx %>/img/bcf1/bcf-1-obj-30.png" />
      <img class="bcf-1-firepipe-off bcf1_29" src="<%= ctx %>/img/bcf1/bcf-1-firepipe-off0.png" />
      <img class="bcf-1-firepipe-on  bcf1_29" src="<%= ctx %>/img/bcf1/bcf-1-firepipe-on0.png" />
      <img class="bcf-1-phone-off-2" src="<%= ctx %>/img/bcf1/bcf-1-phone-off-20.png" />
      <img class="bcf-1-phone-on-2 bcf1_14" src="<%= ctx %>/img/bcf1/bcf-1-phone-on-20.png" />
      <img class="bcf-1-phone-off-1" src="<%= ctx %>/img/bcf1/bcf-1-phone-off-10.png" />
      <img class="bcf-1-phone-on-1 bcf1_13" src="<%= ctx %>/img/bcf1/bcf-1-phone-on-10.png" />
      ...
      <img class="bcf-1-stick-off-1 bcf1_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-off-10.png" />
      <img class="bcf-1-stick-on-1 bcf1_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-on-10.png" />
      <img class="bcf-1-stick-off-2 bcf1_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-off-20.png" />
      <img class="bcf-1-stick-on-2 bcf1_132" src="<%= ctx %>/img/bcf1/bcf-1-stick-on-20.png" />
      ...
      <img class="bcf-1-motor-on bcf1_46" src="<%= ctx %>/img/bcf1/bcf-1-motor-on0.png" />
      <img class="bcf-1-pen-off" src="<%= ctx %>/img/bcf1/bcf-1-pen-off0.png" />
      <img class="bcf-1-pen-on bcf1_22" src="<%= ctx %>/img/bcf1/bcf-1-pen-on0.png" />
      <img class="bcf-1-tray-1 bcf1_51" src="<%= ctx %>/img/bcf1/bcf-1-tray-10.png" />
      <img class="bcf-1-tray-2 bcf1_3" src="<%= ctx %>/img/bcf1/bcf-1-tray-20.png" />
      <img class="bcf-1-tray-3" src="<%= ctx %>/img/bcf1/bcf-1-tray-30.png" />
      <img class="bcf-1-bong-1" src="<%= ctx %>/img/bcf1/bcf-1-bong-10.png" />
      <img class="bcf-1-bong-2 bcf1_34" src="<%= ctx %>/img/bcf1/bcf-1-bong-20.png" />
      <img class="bcf-1-bong-3 bcf1_33" src="<%= ctx %>/img/bcf1/bcf-1-bong-30.png" />
      <img class="bcf-1-door-open-1  bcf1_2" src="<%= ctx %>/img/bcf1/bcf-1-door-open-10.png" />
      <img class="bcf-1-door-close-1  bcf1_2" src="<%= ctx %>/img/bcf1/bcf-1-door-close-10.png" />
      <img class="bcf-1-bong-4" src="<%= ctx %>/img/bcf1/bcf-1-bong-40.png" />
      <img class="bcf-1-bong-5 bcf1_2" src="<%= ctx %>/img/bcf1/bcf-1-bong-50.png" />
      <img class="bcf-1-bong-6 bcf1_2" src="<%= ctx %>/img/bcf1/bcf-1-bong-60.png" />
      ...
      <img class="bcf-1-air-cycle bcf1_60" src="<%= ctx %>/img/bcf1/bcf-1-air-cycle0.png" />
      <img class="bcf-1-sensor-off-1" src="<%= ctx %>/img/bcf1/bcf-1-sensor-off-10.png" />
      <img class="bcf-1-sensor-on-1 bcf1_9" src="<%= ctx %>/img/bcf1/bcf-1-sensor-on-10.png" />
      ...
      <img class="bcf-1-cycle bcf1_39 bcf1_40" src="<%= ctx %>/img/bcf1/bcf-1-cycle0.png" />
      <img class="bcf-1-rotate-1 bcf1_59" src="<%= ctx %>/img/bcf1/bcf-1-rotate-10.png" />
      <img class="bcf-1-rotate-2 bcf1_59" src="<%= ctx %>/img/bcf1/bcf-1-rotate-20.png" />
      <img class="bcf-1-rotate-3 bcf1_39 bcf1_40" src="<%= ctx %>/img/bcf1/bcf-1-rotate-30.png" />
      <img class="bcf-1-alarm-1 bcf1_74" src="<%= ctx %>/img/bcf1/bcf-1-alarm-10.png" />
      <img class="bcf-1-alarm-2 bcf1_85" src="<%= ctx %>/img/bcf1/bcf-1-alarm-20.png" />
      <img class="bcf-1-alarm-3 bcf1_76" src="<%= ctx %>/img/bcf1/bcf-1-alarm-30.png" />
      <img class="bcf-1-alarm-4 bcf1_90" src="<%= ctx %>/img/bcf1/bcf-1-alarm-40.png" />
      <img class="bcf-1-alarm-5 bcf1_88" src="<%= ctx %>/img/bcf1/bcf-1-alarm-50.png" />
      <img class="bcf-1-alarm-6 bcf1_66" src="<%= ctx %>/img/bcf1/bcf-1-alarm-60.png" />
      <img class="bcf-1-alarm-7 bcf1_67" src="<%= ctx %>/img/bcf1/bcf-1-alarm-70.png" />
      <img class="bcf-1-alarm-8 bcf1_79" src="<%= ctx %>/img/bcf1/bcf-1-alarm-80.png" />
      <img class="bcf-1-alarm-9 bcf1_69" src="<%= ctx %>/img/bcf1/bcf-1-alarm-90.png" />
      <img class="bcf-1-alarm-10 bcf1_81" src="<%= ctx %>/img/bcf1/bcf-1-alarm-100.png" />
      <img class="bcf-1-alarm-11 bcf1_80" src="<%= ctx %>/img/bcf1/bcf-1-alarm-110.png" />
      <img class="bcf-1-alarm-12 bcf1_72" src="<%= ctx %>/img/bcf1/bcf-1-alarm-120.png" />
      <img class="bcf-1-alarm-13 bcf1_83" src="<%= ctx %>/img/bcf1/bcf-1-alarm-130.png" />
      <img class="bcf-1-alarm-14 bcf1_71" src="<%= ctx %>/img/bcf1/bcf-1-alarm-140.png" />
      <img class="bcf-1-enrich-gray bcf1_139" src="<%= ctx %>/img/bcf1/bcf-1-enrich-gray0.png" />
      <img class="bcf-1-enrich-red" src="<%= ctx %>/img/bcf1/bcf-1-enrich-red0.png" />
      <img class="bcf-1-enrich-green bcf1_27" src="<%= ctx %>/img/bcf1/bcf-1-enrich-green0.png" />
      <img class="bcf-1-amm-gray bcf1_141" src="<%= ctx %>/img/bcf1/bcf-1-amm-gray0.png" />
      <img class="bcf-1-amm-red" src="<%= ctx %>/img/bcf1/bcf-1-amm-red0.png" />
      <img class="bcf-1-amm-green bcf1_28" src="<%= ctx %>/img/bcf1/bcf-1-amm-green0.png" />
      <div class="bcf-1-enrich-off-box bcf1_138"></div>
      <div class="bcf-1-enrich-on-box bcf1_139"></div>
      <div class="bcf-1-amm-off-box  bcf1_140"></div>
      <div class="bcf-1-amm-on-box bcf1_141"></div>
      <div class="bcf-1-jog-stop-box"></div>
      <div class="bcf-1-jog-manual-box bcf1_57 bcf1_59"></div>
      <div class="bcf-1-jog-on-box bcf1_56 bcf1_58"></div>
      <div class="bcf-1-stop-box-1"></div>
      <div class="bcf-1-manual-box-1 bcf1_136"></div>
      <div class="bcf-1-auto-box-1 bcf1_137"></div>
      <div class="bcf-1-stop-box-2"></div>
      <div class="bcf-1-manual-box-2 bcf1_134"></div>
      <div class="bcf-1-auto-box-2"></div>
      <div class="bcf-1-1-sok-box bcf1_41"></div>
      <div class="bcf-1-2-sok-box bcf1_48"></div>
      <div class="bcf-1-3-sok-box bcf1_49"></div>
      <div class="bcf-1-dt-2 bcf1_3"></div>
      <div class="bcf-1-dt-1 bcf1_51"></div>
      <div class="bcf-1-ro-on bcf1_52"></div>
      <div class="bcf-1-ro-off"></div>
      <div class="bcf-1-dt-3"></div>
      <div class="bcf-1-flamesw-box bcf1_17"></div>
      <div class="bcf-1-flame-box bcf1_18"></div>
      <div class="bcf-1-fire-box bcf1_16"></div>
      <img class="bcf-1-fire-1 bcf1_30" src="<%= ctx %>/img/fireggg.gif" />
      <img class="bcf-1-fire-2  bcf1_16" src="<%= ctx %>/img/fireggg.gif" />
    </div>
    ...
    <div class="bcf-right-panel">
      ...
      <div class="bcf-top-row">
        ...
        <div class="bcf-left-col">
          ...
          <div class="bcf-temp-panel">
            ...
            <div class="tp-grid">
              ...
              <div class="tp-dc"><div class="tp-val BCF1_40046">--</div></div>
              <div class="tp-dc"><div class="tp-val BCF1_40047">--</div></div>
              <div class="tp-dc tp-last-col"><div class="tp-val blue BCF1_40052">--</div></div>

              <!-- SP 행 (설정값) -->
              <div class="tp-row-label tp-last-row">SP</div>
              <div class="tp-dc tp-last-row"><div class="tp-val BCF1_40069">--</div></div>
              <div class="tp-dc tp-last-row"><div class="tp-val BCF1_40070">--</div></div>
              <div class="tp-dc tp-last-col tp-last-row"><div class="tp-val blue BCF1_40071">--</div></div>
        ...
        <div class="bcf-auto-panel">
          ...
          <div class="auto-list">
            <div class="auto-item state-red" data-tag="bcf1_25"  data-text-0="수동 SS"            data-text-1="자동 SS">수동 SS</div>
            <div class="auto-item state-gray" data-tag="bcf1_20" data-text-0="DC POWER OFF"       data-text-1="DC POWER ON"  data-gray="true">DC POWER OFF</div>
            <div class="auto-item state-red" data-tag="bcf1_19"  data-text-0="비상정지"            data-text-1="비상정지">비상정지</div>
            <div class="auto-item state-red" data-tag="bcf1_15"  data-text-0="배기 파이로트 OFF"   data-text-1="배기 파이로트 ON">배기 파이로트 OFF</div>
            <div class="auto-item state-green" data-tag="bcf1_18" data-text-0="입구문 파이로트 OFF" data-text-1="입구문 파이로트 ON" data-invert="true">입구문 파이로트 OFF</div>
            <div class="auto-item state-red" data-tag="bcf1_17"  data-text-0="입구문 커튼SW OFF"   data-text-1="입구문 커튼SW ON">입구문 커튼SW OFF</div>
            <div class="auto-item state-red" data-tag="bcf1_22"  data-text-0="팬 정지"             data-text-1="팬 구동">팬 정지</div>
            <div class="auto-item state-red" data-tag="bcf1_1"   data-text-0="입구문 열림"         data-text-1="입구문 닫힘">입구문 열림</div>
            <div class="auto-item state-red" data-tag="bcf1_4"   data-text-0="E/V 하강"            data-text-1="E/V 상승">E/V 하강</div>
            <div class="auto-item state-red" data-tag="bcf1_7"   data-text-0="중간문 닫힘"         data-text-1="중간문 닫힘">중간문 닫힘</div>
            <div class="auto-item state-red" data-tag="bcf1_107" data-text-0="로내롤러 자동조강"    data-text-1="로내롤러 자동조강">로내롤러 자동조강</div>
            <div class="auto-item state-red" data-tag="bcf1_53"  data-text-0="장입 자동스탭 준비"  data-text-1="장입 자동스탭 준비">장입 자동스탭 준비</div>
            <div class="auto-item state-red" data-tag="bcf1_54"  data-text-0="본체 자동스탭 준비"  data-text-1="본체 자동스탭 준비">본체 자동스탭 준비</div>
            <div class="auto-item state-red" data-tag="bcf1_55"  data-text-0="추출 자동스탭 준비"  data-text-1="추출 자동스탭 준비">추출 자동스탭 준비</div>
          </div>
        </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF1_40015 -->
        <td colspan="2"><div class="zbox red BCF1_40015">BCF1_40015</div></td>
        <!-- 승온2 → BCF1_40016 -->
        <td colspan="2"><div class="zbox red BCF1_40016">BCF1_40016</div></td>
        <!-- 침탄1 → BCF1_40017 -->
        <td colspan="2"><div class="zbox red BCF1_40017">BCF1_40017</div></td>
        <!-- 침탄2 → BCF1_40018 -->
        <td colspan="2"><div class="zbox red BCF1_40018">BCF1_40018</div></td>
        <!-- 확산1 → BCF1_40019 -->
        <td colspan="2"><div class="zbox red BCF1_40019">BCF1_40019</div></td>
        <!-- 확산2 → BCF1_40020 -->
        <td colspan="2"><div class="zbox red BCF1_40020">BCF1_40020</div></td>
        <!-- 강온 → BCF1_40021 -->
        <td colspan="2"><div class="zbox red BCF1_40021">BCF1_40021</div></td>
        <!-- 로냉 → BCF1_40023 -->
        <td colspan="2"><div class="zbox red BCF1_40023">BCF1_40023</div></td>
        <!-- 드레인 → BCF1_40025 -->
        <td colspan="2"><div class="zbox red BCF1_40025">BCF1_40025</div></td>
      </tr>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF1_40028 -->
        <td colspan="2"><div class="zbox yellow BCF1_40028">BCF1_40028</div></td>
        <!-- 승온2 → BCF1_40029 -->
        <td colspan="2"><div class="zbox yellow BCF1_40029">BCF1_40029</div></td>
        <!-- 침탄1 → BCF1_40030 -->
        <td colspan="2"><div class="zbox yellow BCF1_40030">BCF1_40030</div></td>
        <!-- 침탄2 → BCF1_40031 -->
        <td colspan="2"><div class="zbox yellow BCF1_40031">BCF1_40031</div></td>
        <!-- 확산1 → BCF1_40032 -->
        <td colspan="2"><div class="zbox yellow BCF1_40032">BCF1_40032</div></td>
        <!-- 확산2 → BCF1_40033 -->
        <td colspan="2"><div class="zbox yellow BCF1_40033">BCF1_40033</div></td>
        <!-- 강온 → BCF1_40034 -->
        <td colspan="2"><div class="zbox yellow BCF1_40034">BCF1_40034</div></td>
        <!-- 로냉 → BCF1_40035 -->
        <td colspan="2"><div class="zbox yellow BCF1_40035">BCF1_40035</div></td>
        <!-- 드레인 → BCF1_40036 -->
        <td colspan="2"><div class="zbox yellow BCF1_40036">BCF1_40036</div></td>
      </tr>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF1_40046 (공유) -->
        <td colspan="2"><div class="zbox BCF1_40046">BCF1_40046</div></td>
        <!-- 승온2 → BCF1_40046 -->
        <td colspan="2"><div class="zbox BCF1_40046">BCF1_40046</div></td>
        <!-- 침탄1 → BCF1_40046 -->
        <td colspan="2"><div class="zbox BCF1_40046">BCF1_40046</div></td>
        ...
        <td colspan="2"><div class="zbox BCF1_40046">BCF1_40046</div></td>
        <!-- 로냉 → BCF1_40047 -->
        <td colspan="2"><div class="zbox BCF1_40047">BCF1_40047</div></td>
        <!-- 드레인 → BCF1_40047 -->
        <td colspan="2"><div class="zbox BCF1_40047">BCF1_40047</div></td>
      </tr>
      ...
      <tr>
        ...
        <!-- 승온1 → BCF1_40038 -->
        <td colspan="2"><div class="zbox yellow BCF1_40038">BCF1_40038</div></td>
        <!-- 승온2 → BCF1_40039 -->
        <td colspan="2"><div class="zbox yellow BCF1_40039">BCF1_40039</div></td>
        <!-- 침탄1 → BCF1_40040 -->
        <td colspan="2"><div class="zbox yellow BCF1_40040">BCF1_40040</div></td>
        <!-- 침탄2 → BCF1_40041 -->
        <td colspan="2"><div class="zbox yellow BCF1_40041">BCF1_40041</div></td>
        <!-- 확산1 → BCF1_40042 -->
        <td colspan="2"><div class="zbox yellow BCF1_40042">BCF1_40042</div></td>
        <!-- 확산2 → BCF1_40043 -->
        <td colspan="2"><div class="zbox yellow BCF1_40043">BCF1_40043</div></td>
        <!-- 강온 → BCF1_40044 -->
        <td colspan="2"><div class="zbox yellow BCF1_40044">BCF1_40044</div></td>
        <!-- 로냉 → BCF1_40070 -->
        <td colspan="2"><div class="zbox yellow BCF1_40070">BCF1_40070</div></td>
        <!-- 드레인 → BCF1_40070 -->
        <td colspan="2"><div class="zbox yellow BCF1_40070">BCF1_40070</div></td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 침탄1 → BCF1_40052 -->
        <td colspan="2"><div class="zbox cyan BCF1_40052">BCF1_40052</div></td>
        <!-- 침탄2 → BCF1_40052 -->
        <td colspan="2"><div class="zbox cyan BCF1_40052">BCF1_40052</div></td>
        <!-- 확산1 → BCF1_40052 -->
        <td colspan="2"><div class="zbox cyan BCF1_40052">BCF1_40052</div></td>
      ...
      <tr>
        ...
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 침탄1 → BCF1_40048 -->
        <td colspan="2"><div class="zbox cyan BCF1_40048">BCF1_40048</div></td>
        <!-- 침탄2 → BCF1_40049 -->
        <td colspan="2"><div class="zbox cyan BCF1_40049">BCF1_40049</div></td>
        <!-- 확산1 → BCF1_40050 -->
        <td colspan="2"><div class="zbox cyan BCF1_40050">BCF1_40050</div></td>
        <!-- 확산2 → BCF1_40051 -->
        <td colspan="2"><div class="zbox cyan BCF1_40051">BCF1_40051</div></td>
        <!-- 강온 → empty -->
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 로냉 → empty -->
        <td colspan="2"><div class="zbox empty"></div></td>
...
<style>
@keyframes bcf1-spin { to { transform: rotate(360deg); } }
</style>
...
(function() {
  ...
  /* DOM 스캔
     bcf1_숫자    → 비트(show/hide)
     BCF1_숫자    → 아날로그(→ bcf1_s_숫자 키)
     [data-tag]   → 자동운전 상태 아이템 (색+텍스트 갱신) */
  var bitElMap    = {};  // 'bcf1_12'      → [el, ...]
  var wordElMap   = {};  // 'bcf1_s_40046' → [el, ...]
  var statusElMap = {};  // 'bcf1_25'      → [el, ...]
  ...
  document.querySelectorAll('[class]').forEach(function(el) {
    el.className.split(/\s+/).forEach(function(cls) {
      ...
      } else if (/^BCF1_\d+$/.test(cls)) {
        var apiTag = 'bcf1_s_' + cls.slice(5);
  ...
  document.querySelectorAll('[data-tag]').forEach(function(el) {
    var tag = el.getAttribute('data-tag');  // e.g. 'bcf1_25'
  ...
  function applyData(data) {
    ...
    /* 비트: 1→보임, 0→숨김 / bcf1_59 예외: 1→회전, 0→정지 */
    Object.keys(bitElMap).forEach(function(tag) {
      if (data[tag] == null) return;
      var isOn = (data[tag] === 1 || data[tag] === true);
      bitElMap[tag].forEach(function(el) {
        if (tag === 'bcf1_59' && el.tagName === 'IMG') {
          el.style.visibility = 'visible';
          el.style.animation  = isOn ? 'bcf1-spin 1s linear infinite' : 'none';
        } else {
  ...
  function fetchData() {
    ...
    .catch(function(err) { console.warn('[BCF1] PLC fetch 실패:', err); })
    .finally(function() { busy = false; });
  }

  /* 현재 경보 Tabulator (1호기 = plcId: 'dongwoo_01') */
