...
<div class="page-wrap">
  ...
  <div class="group-1">
    ...
    <div class="bcf-6-detail">
      ...
      <img class="bcf-6-fire-1 bcf6_138" src="<%= ctx %>/img/fireggg.gif" />
      <img class="bcf-6-fire-2 bcf6_138" src="<%= ctx %>/img/fireggg.gif" />
      <img class="bcf-6-fire-3 bcf6_125" src="<%= ctx %>/img/fireggg.gif" />
      <img class="bcf-6-fire-4 bcf6_125" src="<%= ctx %>/img/fireggg.gif" />
