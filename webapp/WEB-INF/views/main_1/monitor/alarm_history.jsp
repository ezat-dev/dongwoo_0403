...
/* ── 초기화 ── */
document.getElementById('dateFrom').value = '${not empty defaultFrom ? defaultFrom : "2026-06-01"}';
document.getElementById('dateTo').value   = '${not empty defaultTo   ? defaultTo   : "2026-06-17"}';
